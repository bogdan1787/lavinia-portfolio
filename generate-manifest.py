...
def image_entry(rel: Path, filename: str) -> dict:
    ...
    # Thumbnail path (generated by optimize-images.py)
    thumb_abs = Path(__file__).parent / rel.parent / "thumbs" / filename
    if thumb_abs.exists():
        entry["thumb"] = (rel.parent / "thumbs" / filename).as_posix()
